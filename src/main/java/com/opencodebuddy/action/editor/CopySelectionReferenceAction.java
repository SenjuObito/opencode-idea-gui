...
public class CopySelectionReferenceAction extends AnAction implements DumbAware {
    ...
    CopySelectionReferenceAction(@NotNull SelectionReferenceBuilder selectionReferenceBuilder,
        ...
        super(
                OpenCodeBuddyBundle.message("action.copyAiReference.text"),
                OpenCodeBuddyBundle.message("action.copyAiReference.description"),
                null
        );
    ...
    public void actionPerformed(@NotNull AnActionEvent e) {
        ...
        try {
            ...
            showError(project, OpenCodeBuddyBundle.message("action.copyAiReference.copyFailed"));
    ...
    void handleBuildResult(@Nullable Project project, @NotNull SelectionReferenceBuilder.Result result) {
        ...
        try {
            ...
            showClipboardWriteFailure(project, OpenCodeBuddyBundle.message("action.copyAiReference.copyFailed"));
        }
    }
    ...
    private void showClipboardWriteFailure(@Nullable Project project, @NotNull String message) {
        showDialog(project, message, OpenCodeBuddyBundle.message("dialog.error.title"), true);
    }
    ...
    private void showInfo(@Nullable Project project, @NotNull String message) {
        LOG.info(message);
        showDialog(project, message, OpenCodeBuddyBundle.message("dialog.info.title"), false);
    }
