...
public class QuickFixWithClaudeAction extends AnAction implements DumbAware {
    ...
    public QuickFixWithClaudeAction() {
        super(
            OpenCodeBuddyBundle.message("action.quickFixWithClaude.text"),
            OpenCodeBuddyBundle.message("action.quickFixWithClaude.description"),
            null
        );
    }
    ...
    private void showQuickFixInput(@NotNull Project project, @NotNull Editor editor) {
        ...
        JBLabel label = new JBLabel(OpenCodeBuddyBundle.message("action.quickFixWithClaude.dialogLabel"));
        ...
        historyUpButton.setToolTipText(OpenCodeBuddyBundle.message("action.quickFixWithClaude.historyUpTooltip"));
        ...
        historyDownButton.setToolTipText(OpenCodeBuddyBundle.message("action.quickFixWithClaude.historyDownTooltip"));
        ...
        JButton submitButton = new JButton(OpenCodeBuddyBundle.message("action.quickFixWithClaude.submit"));
        submitButton.setToolTipText(OpenCodeBuddyBundle.message("action.quickFixWithClaude.submitTooltip"));

        JButton cancelButton = new JButton(OpenCodeBuddyBundle.message("action.quickFixWithClaude.cancel"));
        cancelButton.setToolTipText(OpenCodeBuddyBundle.message("action.quickFixWithClaude.cancelTooltip"));
        ...
        JBPopup popup = JBPopupFactory.getInstance()
                ...
                .setResizable(true)
                .setMovable(true)
                .setTitle(OpenCodeBuddyBundle.message("action.quickFixWithClaude.dialogTitle"))
                .createPopup();
    ...
    private void executeQuickFix(@NotNull Project project, @NotNull Editor editor, @NotNull String userPrompt) {
        ...
        if (toolWindow == null) {
            ClaudeNotifier.showError(project, OpenCodeBuddyBundle.message("quickfix.toolWindowNotFound"));
            return;
        }
        ...
        quickFixWindow.sendQuickFixMessage(userPrompt, true, new MessageCallback() {
            ...
            public void onError(String error) {
                ApplicationManager.getApplication().invokeLater(() -> {
                    ClaudeNotifier.showError(project, OpenCodeBuddyBundle.message("quickfix.failed", error));
            ...
            public void onComplete(SDKResult result) {
                com.opencodebuddy.service.QuickFixService.handleAIResponse(project, editor, result.finalResult);
            }
        });
    }
