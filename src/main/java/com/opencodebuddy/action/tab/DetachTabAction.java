...
public class DetachTabAction extends AnAction implements DumbAware {
    ...
    public DetachTabAction() {
        super(
                OpenCodeBuddyBundle.message("action.detachTab.text"),
                OpenCodeBuddyBundle.message("action.detachTab.description"),
                null
        );
    }
    ...
    public void actionPerformed(@NotNull AnActionEvent e) {
        ...
        if (chatWindow == null) {
            ...
            Messages.showErrorDialog(
                    project,
                    OpenCodeBuddyBundle.message("action.detachTab.error.noChatWindow"),
                    OpenCodeBuddyBundle.message("action.detachTab.error.title")
            );
            return;
        }
        ...
        if (sessionId != null && DetachedWindowManager.isDetached(project, sessionId)) {
            ...
            Messages.showInfoMessage(
                    project,
                    OpenCodeBuddyBundle.message("action.detachTab.error.alreadyDetached"),
                    OpenCodeBuddyBundle.message("action.detachTab.error.title")
            );
            return;
        }
        ...
        if (contentManager.getContentCount() <= 1) {
            ...
            Messages.showWarningDialog(
                    project,
                    OpenCodeBuddyBundle.message("action.detachTab.error.lastTab"),
                    OpenCodeBuddyBundle.message("action.detachTab.error.title")
            );
            return;
        }
    ...
    private void detachTab(@NotNull Project project,
        ...
        ApplicationManager.getApplication().invokeLater(() -> {
            ...
            try {
                ...
                Messages.showErrorDialog(
                        project,
                        OpenCodeBuddyBundle.message("action.detachTab.error.failed") + ": " + ex.getMessage(),
                        OpenCodeBuddyBundle.message("action.detachTab.error.title")
                );
            } finally {
