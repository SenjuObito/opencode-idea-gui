...
/**
 * Action to rename the current tab in the OpenCode Buddy tool window.
...
public class RenameTabAction extends AnAction implements DumbAware {
    ...
    public RenameTabAction() {
        super(
            OpenCodeBuddyBundle.message("action.renameTab.text"),
            OpenCodeBuddyBundle.message("action.renameTab.description"),
            null
        );
    }
    ...
    public void actionPerformed(@NotNull AnActionEvent e) {
        ...
        String newName = Messages.showInputDialog(
            project,
            OpenCodeBuddyBundle.message("action.renameTab.dialogLabel"),
            OpenCodeBuddyBundle.message("action.renameTab.dialogTitle"),
            null,
            currentName,
    ...
    private static class TabNameInputValidator implements InputValidatorEx {
        ...
        public @Nullable String getErrorText(@Nullable String inputString) {
            if (inputString == null || inputString.trim().isEmpty()) {
                return OpenCodeBuddyBundle.message("action.renameTab.error.empty");
            }
            if (inputString.trim().length() > MAX_TAB_NAME_LENGTH) {
                return OpenCodeBuddyBundle.message("action.renameTab.error.tooLong");
            }
            return null;
        }
    }
