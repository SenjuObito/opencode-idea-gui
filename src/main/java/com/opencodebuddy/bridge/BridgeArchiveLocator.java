...
final class BridgeArchiveLocator {
    ...
    private static void addPluginRootCandidates(List<File> candidates, File pluginsRoot) {
        ...
        // Enumerate every installed plugin directory — the on-disk name follows
        // rootProject.name (e.g. "opencode-buddy-jetbrains") which matches
        // neither the legacy dir name nor the plugin id.
