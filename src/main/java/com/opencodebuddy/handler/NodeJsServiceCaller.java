...
public class NodeJsServiceCaller {
    ...
    public String callNodeJsFavoritesService(String functionName, String sessionId) throws Exception {
        ...
        String bridgePath = resolveBridgePath();
    ...
    /**
     * Resolve the extracted ai-bridge directory that hosts the *.cjs services.
     */
    private static String resolveBridgePath() throws Exception {
        java.io.File bridgeDir = BridgePreloader.getSharedResolver().findSdkDir();
        if (bridgeDir == null) {
            throw new Exception("ai-bridge directory not found");
        }
        return bridgeDir.getAbsolutePath();
    }
