    ...
    public void handleGetPromptEnhancerConfig() {
        ...
        ApplicationManager.getApplication().executeOnPooledThread(() -> {
            try {
                ...
                showError(OpenCodeBuddyBundle.message("projectConfig.promptEnhancer.getFailed", e.getMessage()));
            }
        });
    }
    ...
    public void handleGetCommitAiConfig() {
        ...
        ApplicationManager.getApplication().executeOnPooledThread(() -> {
            try {
                ...
                showError(OpenCodeBuddyBundle.message("projectConfig.commitAi.getFailed", e.getMessage()));
            }
        });
    }
