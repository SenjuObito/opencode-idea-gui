package com.opencodebuddy.handler.context;
        ...
        if (JAVA_PLUGIN_AVAILABLE) {
            try {
                Class<?> javaCollectorClass = Class.forName(
                    "com.opencodebuddy.handler.context.JavaContextCollector");
        ...
        if (PYTHON_PLUGIN_AVAILABLE) {
            try {
                Class<?> pythonCollectorClass = Class.forName(
                    "com.opencodebuddy.handler.context.PythonContextCollector");
