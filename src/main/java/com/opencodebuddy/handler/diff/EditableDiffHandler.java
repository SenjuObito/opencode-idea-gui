        ...
        try {
            ...
            if (!isNewFile) {
                ...
                if (!file.exists()) {
                    ...
                    browserBridge.showErrorToast(OpenCodeBuddyBundle.message("diff.fileNotFoundDetail", filePath));
        ...
        try {
            ...
            if (vFile != null) {
                ...
                try {
                    ...
                    browserBridge.showErrorToast(OpenCodeBuddyBundle.message("diff.fileReadFailedDetail", e.getMessage()));
                    return;
                }
            }
            ...
            String tabName = OpenCodeBuddyBundle.message("diff.tabName", fileName, operations.size());
            ...
            browserBridge.showErrorToast(OpenCodeBuddyBundle.message("diff.openFailedDetail", e.getMessage()));
        }
    }
