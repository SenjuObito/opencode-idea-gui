package com.opencodebuddy.handler.diff;
...
import com.opencodebuddy.util.LineSeparatorUtil;
...
public class InteractiveDiffManager {
    ...
    private static void showInteractiveDiffInternal(
        ...
        // Create diff request
        String leftTitle = request.isNewFile() ? OpenCodeBuddyBundle.message("diff.newFileTitle") : OpenCodeBuddyBundle.message("diff.originalTitle");
        SimpleDiffRequest diffRequest = new SimpleDiffRequest(
                request.getTabName(),
                originalDiffContent,
                proposedDiffContent,
                leftTitle,
                OpenCodeBuddyBundle.message("diff.proposedTitle")
        );
        ...
        JButton rejectButton = new JButton(OpenCodeBuddyBundle.message("diff.reject"));
        ...
        JButton applyButton = new JButton(OpenCodeBuddyBundle.message("diff.apply"));
        ...
        if (isPermissionReview) {
            JButton applyAlwaysButton = new JButton(OpenCodeBuddyBundle.message("diff.applyAlways"));
    ...
    private static AnAction createRejectAction(
        ...
        return new AnAction(OpenCodeBuddyBundle.message("diff.reject"), OpenCodeBuddyBundle.message("diff.reject.description"), AllIcons.Actions.Cancel) {
            @Override
            @RequiresEdt
    ...
    private static AnAction createApplyAlwaysAction(
        ...
        return new AnAction(OpenCodeBuddyBundle.message("diff.applyAlways"), OpenCodeBuddyBundle.message("diff.applyAlways.description"), AllIcons.Actions.Checked_selected) {
            @Override
            @RequiresEdt
            public void actionPerformed(@NotNull AnActionEvent e) {
                if (actionApplied.compareAndSet(false, true)) {
    ...
    private static AnAction createApplyAction(
        ...
        return new AnAction(OpenCodeBuddyBundle.message("diff.apply"), OpenCodeBuddyBundle.message("diff.apply.description"), AllIcons.Actions.Checked) {
            @Override
            @RequiresEdt
            public void actionPerformed(@NotNull AnActionEvent e) {
                if (actionApplied.compareAndSet(false, true)) {
