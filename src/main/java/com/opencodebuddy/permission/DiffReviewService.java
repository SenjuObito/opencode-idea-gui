...
import com.opencodebuddy.util.WslPathUtil;
import com.opencodebuddy.handler.diff.DiffResult;
import com.opencodebuddy.handler.diff.InteractiveDiffManager;
import com.opencodebuddy.handler.diff.InteractiveDiffRequest;
...
public class DiffReviewService {
    ...
    public static CompletableFuture<DiffReviewResult> reviewFileChange(
        ...
        try {
            ...
            String tabName = OpenCodeBuddyBundle.message("diff.reviewTabName", fileName);
