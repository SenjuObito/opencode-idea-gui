package com.opencodebuddy.permission;
...
public class PermissionDialog extends DialogWrapper {
    ...
    public PermissionDialog(@Nullable Project project, PermissionRequest request) {
        ...
        setTitle(OpenCodeBuddyBundle.message("permission.dialogTitle"));
        setModal(true);
        setResizable(false);
    ...
    private void loadHtml() {
        try {
            ...
            if (is == null) {
                throw new RuntimeException(OpenCodeBuddyBundle.message("permission.htmlNotFound"));
            }
            ...
            browser.loadHTML(OpenCodeBuddyBundle.message("permission.loadFailed"));
        }
    }
    ...
    private String translateToolName(String toolName) {
        ...
        try {
            return OpenCodeBuddyBundle.message(key);
        } catch (Exception e) {
            return toolName;
        }
    }
