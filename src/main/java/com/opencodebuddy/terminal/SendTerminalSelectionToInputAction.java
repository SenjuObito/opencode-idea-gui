package com.opencodebuddy.terminal;

import com.opencodebuddy.i18n.OpenCodeBuddyBundle;
import com.opencodebuddy.util.SelectionTextUtils;
...
public class SendTerminalSelectionToInputAction extends AnAction implements DumbAware {
    ...
    static final String ACTION_ID = "OpenCodeBuddy.SendTerminalSelectionToInputAction";
    ...
    public SendTerminalSelectionToInputAction() {
        super(
                OpenCodeBuddyBundle.message("action.sendConsoleSelection.text"),
                OpenCodeBuddyBundle.message("action.sendConsoleSelection.description"),
                null
        );
    }
