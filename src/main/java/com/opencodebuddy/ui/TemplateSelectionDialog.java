...
public class TemplateSelectionDialog extends DialogWrapper {
    ...
    public TemplateSelectionDialog() {
        super(true);
        setTitle(OpenCodeBuddyBundle.message("template.select.title"));
        setOKButtonText(OpenCodeBuddyBundle.message("template.select.ok"));
        setCancelButtonText(OpenCodeBuddyBundle.message("template.select.cancel"));
    ...
    protected @Nullable JComponent createCenterPanel() {
        ...
        if (listModel.isEmpty()) {
            JLabel emptyLabel = new JLabel(OpenCodeBuddyBundle.message("template.select.empty"));
