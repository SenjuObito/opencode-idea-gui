...
public class DetachedChatFrame extends JFrame {
    ...
    private JPanel createToolbar() {
        ...
        // Reattach button
        JButton reattachBtn = new JButton(OpenCodeBuddyBundle.message("detachedWindow.reattach"));
        reattachBtn.setToolTipText(OpenCodeBuddyBundle.message("detachedWindow.reattach.tooltip"));
    ...
    private void onWindowClosing() {
        ...
        int choice = Messages.showYesNoCancelDialog(
                project,
                OpenCodeBuddyBundle.message("detachedWindow.close.message"),
                OpenCodeBuddyBundle.message("detachedWindow.close.title"),
                OpenCodeBuddyBundle.message("detachedWindow.close.reattach"),
                OpenCodeBuddyBundle.message("detachedWindow.close.destroy"),
                OpenCodeBuddyBundle.message("detachedWindow.close.cancel"),
            ...
            try {
                ...
                if (toolWindow == null) {
                    ...
                    Messages.showErrorDialog(
                            this.project,
                            OpenCodeBuddyBundle.message("detachedWindow.reattach.error.noToolWindow"),
                            OpenCodeBuddyBundle.message("detachedWindow.reattach.error.title")
                    );
                    return;
                }
                ...
                Messages.showErrorDialog(
                        this.project,
                        OpenCodeBuddyBundle.message("detachedWindow.reattach.error.failed") + ": " + e.getMessage(),
                        OpenCodeBuddyBundle.message("detachedWindow.reattach.error.title")
                );
            }
        });
