...
public class FontConfigService {
    ...
    private static final String UI_FONT_CUSTOM_FAMILY = "OpenCode Buddy UI Custom";
    private static final String CODE_FONT_CUSTOM_FAMILY = "OpenCode Buddy Code Custom";
