...
public final class SelectionTextUtils {
    ...
    public static void sendToChatWindow(@NotNull Project project, @NotNull String text) {
        try {
            ...
            if (proxy == null) {
                errorNotifier.notify(project, OpenCodeBuddyBundle.message("send.toolWindowNotFound"));
                return;
            }
            if (!proxy.isVisible()) {
            ...
            errorNotifier.notify(project, OpenCodeBuddyBundle.message("send.sendToChatFailed", safeMessage(ex)));
        }
    }
    ...
    private static void notifyError(@Nullable Project project, @NotNull String message) {
        ...
        ApplicationManager.getApplication().invokeLater(() -> {
            ...
            Messages.showErrorDialog(project, message, OpenCodeBuddyBundle.message("dialog.error.title"));
        });
    }
