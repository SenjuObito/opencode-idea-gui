...
public class PluginActionRegistrationTest {
    ...
    public void sendFilePathActionAppearsInProjectTreeAndEditorTabMenus() throws Exception {
        Set<String> groupIds = getActionGroupIds("OpenCodeBuddy.SendFilePathToInputAction");
    ...
    public void copySelectionReferenceActionAppearsInEditorPopupMenuAfterSendSelectionAction() throws Exception {
        ActionRegistration action = getActionRegistration("OpenCodeBuddy.CopySelectionReferenceAction");
        ActionRegistration quickFixAction = getActionRegistration("OpenCodeBuddy.QuickFixWithClaudeAction");

        Assert.assertEquals(
                "com.opencodebuddy.action.editor.CopySelectionReferenceAction",
                action.actionClass
        );
        AddToGroupRegistration editorPopup = action.getAddToGroup("EditorPopupMenu");
        Assert.assertEquals("after", editorPopup.anchor);
        Assert.assertEquals("OpenCodeBuddy.SendSelectionToTerminalAction", editorPopup.relativeToAction);
    ...
    public void editorPopupActionsUseExpectedIcons() throws Exception {
        ActionRegistration sendSelectionAction = getActionRegistration("OpenCodeBuddy.SendSelectionToTerminalAction");
        ActionRegistration copyReferenceAction = getActionRegistration("OpenCodeBuddy.CopySelectionReferenceAction");
        ActionRegistration quickFixAction = getActionRegistration("OpenCodeBuddy.QuickFixWithClaudeAction");

        Assert.assertEquals("/icons/opencode-icon.svg", sendSelectionAction.icon);
        Assert.assertEquals("/icons/opencode-icon.svg", copyReferenceAction.icon);
        Assert.assertEquals("/icons/opencode-icon.svg", quickFixAction.icon);
    }

    @Test
    public void sessionTemplateActionsAreRegistered() throws Exception {
        ActionRegistration saveAsTemplateAction = getActionRegistration("OpenCodeBuddy.SaveAsTemplateAction");
        ActionRegistration createFromTemplateAction = getActionRegistration("OpenCodeBuddy.CreateFromTemplateAction");

        Assert.assertEquals("com.opencodebuddy.action.SaveAsTemplateAction", saveAsTemplateAction.actionClass);
        Assert.assertEquals("com.opencodebuddy.action.CreateFromTemplateAction", createFromTemplateAction.actionClass);
    }
    ...
    public void pluginDeclaresJcefAndUsesStableTemplateActionIcon() throws Exception {
        ...
        ActionRegistration saveAsTemplateAction = getActionRegistration("OpenCodeBuddy.SaveAsTemplateAction");
        Assert.assertEquals("/icons/opencode-icon.svg", saveAsTemplateAction.icon);
    }
