...
public class NodeProcessRegistryHelpersTest {
    ...
    @Test
    public void detectProviderClassifiesDaemonAsOpenCode() {
        assertEquals("opencode", NodeProcessRegistry.detectProviderFromCmd("node /path/daemon.js"));
    }

    @Test
    public void detectProviderClassifiesChannelManager() {
        assertEquals("opencode",
                NodeProcessRegistry.detectProviderFromCmd("node /path/channel-manager.js send"));
    }

    @Test
    public void detectProviderClassifiesOpenCodeCommand() {
        assertEquals("opencode",
                NodeProcessRegistry.detectProviderFromCmd("node /path/opencode-channel.js send"));
    }
