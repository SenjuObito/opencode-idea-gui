...
//  1. `## 1.0.0-opencode.1 (2026-09-06)` / `## [1.0.0]` (Keep a Changelog style)
//  2. `##### **2026年9月2日（v0.5.4）**` — the format webview/scripts/
...
function extractFromChangelog() {
  ...
  // `##### **2026年9月2日（v0.5.4）**` — the extract-changelog.mjs format.
